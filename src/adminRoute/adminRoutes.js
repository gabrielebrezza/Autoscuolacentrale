...
router.post('/admin/updateUser', authenticateJWT, async (req, res) => {
    try {
        ...
        await credentials.findOneAndUpdate({ "_id": dati.id }, { "email": dati.userEemail, "cell": dati.cell,"billingInfo": billingInfo, "licenseNumber": dati.licenseNumber , "expirationFoglioRosa": new Date(dati.expFoglioRosa)});
